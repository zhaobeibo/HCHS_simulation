...
proc printto log = "&homepath./logs/s5_bin_sudaan_&sysdate..log"
			 print= "&homepath./lst/s5_bin_sudaan_&sysdate..lst" new; run; 
...
* miss_ind_mar;
%impute_sudaan_binary(start=3, end=100, corr=ind, corr_full=independent, rr=rr_glm, miss= miss_ind_mar);
%impute_sudaan_binary(start=1, end=100, corr=ind, corr_full=independent, rr=RR_NRadj, miss= miss_ind_mar);

%impute_sudaan_binary(start=50, end=100, corr=exch, corr_full=exchangeable, rr=rr_glm, miss= miss_ind_mar);
