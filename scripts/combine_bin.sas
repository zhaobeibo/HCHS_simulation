...
* s2;
%combine_bin_betas(start=1, end=500, corr=ind, corr_full=independent, rr=_, 
                       input_lib= bs2 );
%combine_bin_betas(start=1, end=500, corr=exch, corr_full=exchangeable,  rr=_, 
                       input_lib= bs2 );
...
%combine_bin_betas(start=1, end=500, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs4);
%combine_bin_betas(start=1, end=500, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs4);
%combine_bin_betas(start=1, end=500, corr=exch, corr_full=exchangeable, rr=_rr_glm_, 
                 input_lib=bs4);;
