...
proc printto log = "&homepath./logs/combine_bin_&sysdate..log"
             print= "&homepath./lst/combine_bin_&sysdate..lst" new; run; 
...
%macro combine_bin_betas(start=, end=, corr=, corr_full = , rr=, 
    ...
    proc sql;
        ...
        right join 
        &pop_lib..betas_pop_bin_&corr. as b 
        on a.parm=b.parm;
    quit;
...
%mend combine_bin_betas;


* bs1 - Binary MI scenarios;
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs1);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs1);
%combine_bin_betas(start=1, end=1000, corr=exch, corr_full=exchangeable, rr=_rr_glm_, 
                 input_lib=bs1);
%combine_bin_betas(start=1, end=1000, corr=exch, corr_full=exchangeable, rr=_rr_nradj_, 
                 input_lib=bs1);

* bs2 - Binary complete case scenarios;
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_, 
                   input_lib=bs2);
%combine_bin_betas(start=1, end=1000, corr=exch, corr_full=exchangeable, rr=_, 
                   input_lib=bs2);

* bs3 - Binary MI with V3 adjusted weights (restricted sample);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs3);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs3);
...
* bs4 - Binary no MI with V3 adjusted weights (restricted sample);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs4);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs4);
...
* bs5 - Binary MI with visit-specific weights (full sample);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs5);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs5);
...
* bs6 - Binary no MI with visit-specific weights (full sample);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_glm_, 
                 input_lib=bs6);
%combine_bin_betas(start=1, end=1000, corr=ind, corr_full=independent, rr=_rr_nradj_, 
                 input_lib=bs6);
